      ...
      <div className="page">
        <div className="cardboard">
          ...
          <Card
            ...
            desc={props.currentCards[0].card.desc}
            url={props.currentCards[0].card.url}
          ...
          <Card
            ...
            setCardNum={props.setCardNum}
            setSelectedCards={props.setSelectedCards}
            desc={props.currentCards[1].card.desc}
            url={props.currentCards[1].card.url}
            nextTurn={props.nextTurn}
          ></Card>
          <Card
            setIsSelecting={props.setIsSelecting}
            ...
            setCardNum={props.setCardNum}
            setSelectedCards={props.setSelectedCards}
            desc={props.currentCards[2].card.desc}
            url={props.currentCards[2].card.url}
            nextTurn={props.nextTurn}
          ></Card>
        </div>
        <style jsx>{`
